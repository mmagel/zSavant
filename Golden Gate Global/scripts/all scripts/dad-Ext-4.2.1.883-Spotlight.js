...
E4D.define('E4D.ux.Spotlight', {
    ...
    /**
     * @cfg animate {Boolean} True to animate the spotlight change (defaults to
     *      true)
     */
    animate : true,
    ...
    createElements : function() {
        var me = this, baseCls = me.baseCls, body = E4D.getBody();
        ...
        me.all = E4D.create('E4D.CompositeElement', [ me.right, me.left, me.top, me.bottom ]);
    },
    ...
    show : function(el, callback, scope) {
        ...
        if (!me.active) {
            ...
            me.all.setDisplayed('');
            me.active = true;
            E4D.EventManager.onWindowResize(me.syncSize, me);
    ...
    hide : function(callback, scope) {
        ...
        E4D.EventManager.removeResizeListener(me.syncSize, me);
    ...
    applyBounds : function(animate, reverse) {
        ...
        viewWidth = E4D.Element.getViewWidth(true), viewHeight = E4D.Element.getViewHeight(true), i = 0, config = false, from, to, clone;
        ...
        // reverse the objects
        if (reverse) {
            clone = E4D.clone(from);
            from = to;
            to = clone;
        }

        if (animate) {
            E4D.Array.forEach([ 'right', 'left', 'top', 'bottom' ], function(side) {
            ...
            E4D.Array.forEach([ 'right', 'left', 'top', 'bottom' ], function(side) {
                me[side].setBox(E4D.apply(from[side], to[side]));
                me[side].repaint();
            }, this);
        }
    },
    ...
    destroy : function() {
        ...
        E4D.destroy(me.right, me.left, me.top, me.bottom);
        delete me.el;
        delete me.all;
    }
});
