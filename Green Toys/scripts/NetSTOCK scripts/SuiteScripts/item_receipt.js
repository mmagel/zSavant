...
function bill(){
	try{
		document.location='https://system.na1.netsuite.com/app/accounting/transactions/vendbill.nl?transform=purchord&whence=&id='+nlapiGetFieldValue('createdfrom')+'&e=T&memdoc=0&rec='+nlapiGetRecordId();
